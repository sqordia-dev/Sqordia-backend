...
Execute unit tests
```
    cd "Sqordia.Lambda.AIGenerationHandler/test/Sqordia.Lambda.AIGenerationHandler.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Sqordia.Lambda.AIGenerationHandler/src/Sqordia.Lambda.AIGenerationHandler"
